...
function ToolTag({ name }) {
  ...
  return (
    <div className="flex items-center gap-2 px-4 py-2 rounded-lg border border-[var(--color-border)] bg-[var(--color-surface)] text-sm font-medium text-[var(--color-text)]">
      {Icon ? <Icon /> : (
        <span className="w-5 h-5 rounded bg-[var(--color-accent)] opacity-60 inline-block" />
      )}
      {name}
    </div>
  )
